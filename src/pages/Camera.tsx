...
export default function Camera() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel border border-white/10 rounded-2xl p-4">
        <div className="flex items-center gap-4">
          <div className="glass-panel border border-white/10 rounded-xl px-3 py-1.5 w-fit">
            <select
              value={selectedHive}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-8 space-y-4">
          <div className="relative aspect-[16/9] bg-black rounded-3xl border border-white/20 overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)] group">
            ...
            <div className="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
              <Layers size={200} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]" />
            </div>
            ...
            {showOverlays &&
              sampleDetections.map(box => (
                ...
                >
                  <div className="absolute -top-6 left-[-2px] bg-[#4ade80] text-black text-[10px] font-mono-data font-bold px-2 py-0.5 rounded shadow whitespace-nowrap">
                    {box.label} ({box.conf}%)
                  </div>
                </div>
              ))}
            ...
            <div className="absolute top-4 left-4 right-4 flex items-center justify-between text-xs text-white z-10">
              <div className="flex items-center gap-3 bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/20 shadow-lg">
              ...
              <div className="bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/20 font-mono-data text-xs font-bold text-white/80 tracking-wide shadow-lg">
            ...
            {!isPlaying && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-10 transition-all">
                <div className="text-center text-white bg-black/50 p-6 rounded-3xl border border-white/10 shadow-2xl">
                  ...
                  <div className="text-xs font-medium text-white/50 mt-1">CV inference suspended</div>
                </div>
              </div>
            )}
            ...
            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-3 z-10">
              <div className="flex items-center gap-2 bg-black/80 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-xl">
                <button
                ...
                <button
                  ...
                  ${showOverlays ? 'bg-[#a78bfa]/20 text-[#c4b5fd] border border-[#a78bfa]/30' : 'bg-transparent text-white/50 hover:bg-white/10 hover:text-white'}`}
                >
                ...
                <button
                  ...
                  ${showHeatmap ? 'bg-[#fbbf24]/20 text-[#fbbf24] border border-[#fbbf24]/30' : 'bg-transparent text-white/50 hover:bg-white/10 hover:text-white'}`}
                >
                  <Activity size={14} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="glass-panel border border-white/10 rounded-2xl p-4 text-center group hover:border-white/20 transition-colors">
              <div className="text-[10px] font-bold uppercase tracking-widest text-white/40">Current Frame Count</div>
              <div className="font-mono-data text-2xl font-bold text-white mt-1 group-hover:text-[#fbbf24] transition-colors">
                {beeCount}
              </div>
            </div>
            <div className="glass-panel border border-white/10 rounded-2xl p-4 text-center group hover:border-white/20 transition-colors">
              <div className="text-[10px] font-bold uppercase tracking-widest text-white/40">Entrance Traffic</div>
              <div className="font-bold text-sm text-[#4ade80] mt-1.5 uppercase tracking-wide">
                ✓ Heavy Foraging
              </div>
            </div>
            <div className="glass-panel border border-white/10 rounded-2xl p-4 text-center group hover:border-white/20 transition-colors">
              <div className="text-[10px] font-bold uppercase tracking-widest text-white/40">Swarming Risk</div>
              <div className="font-bold text-sm text-[#4ade80] mt-1.5 uppercase tracking-wide">
                Low (11% Index)
              </div>
            </div>
            <div className="glass-panel border border-white/10 rounded-2xl p-4 text-center group hover:border-white/20 transition-colors">
              <div className="text-[10px] font-bold uppercase tracking-widest text-white/40">Camera Hardware</div>
              <div className="font-mono-data font-bold text-sm text-white/70 mt-1.5">
                1080p · 24fps
              </div>
            </div>
          </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          {/* AI Vision Diagnosis */}
          <div className="glass-panel-elevated rounded-3xl border border-white/10 p-6 relative overflow-hidden">
            ...
            <div className="text-sm font-medium text-white/80 leading-relaxed bg-[#a78bfa]/10 border border-[#a78bfa]/20 p-4 rounded-2xl mb-5 shadow-inner relative z-10">
            ...
            <div className="space-y-1 relative z-10">
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                <span className="text-xs font-bold uppercase tracking-wider text-white/40">Pollen Carriers:</span>
                <span className="font-mono-data font-bold text-white bg-white/5 px-2 py-0.5 rounded">68% of foragers</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                <span className="text-xs font-bold uppercase tracking-wider text-white/40">Congestion:</span>
                <span className="font-bold text-[#4ade80]">Nominal (Open flow)</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                <span className="text-xs font-bold uppercase tracking-wider text-white/40">Predators:</span>
                <span className="font-bold text-[#4ade80]">None Detected</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-xs font-bold uppercase tracking-wider text-white/40">Model Engine:</span>
                <span className="font-mono-data font-bold text-white/70">BeeYOLOv9-Edge</span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel rounded-3xl border border-white/10 p-6 relative overflow-hidden">
            <div className="flex items-center justify-between mb-5 relative z-10">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-white/40 bg-white/5 px-2 py-1 rounded">{snapshots.length} Snaps</span>
            </div>
              ...
              {snapshots.map(snap => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-bold uppercase tracking-wider text-white group-hover:text-[#60a5fa] transition-colors">{snap.label}</div>
                      <div className="text-[10px] font-bold uppercase tracking-widest text-white/30">{snap.time}</div>
                    </div>
                  </div>
