...
export default function Alerts() {
  ...
  return (
    <div className="space-y-6 max-w-[1500px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel-elevated rounded-3xl p-6 lg:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-bold tracking-wider uppercase text-white/50">Prioritized Triage</span>
          </div>
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-white ai-glow-text">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 glass-panel border border-white/10 rounded-2xl p-4 relative z-10">
        <div className="flex bg-black/40 border border-white/5 rounded-xl p-1 w-full sm:w-auto shadow-inner">
          {[
      ...
      <div className="space-y-4">
        {filtered.map(alert => {
          ...
          return (
            <div
              ...
              ${
                isResolved
                  ? 'opacity-50 grayscale-[50%] border-white/5 glass-panel'
                  : isCritical
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 relative z-10">
                ...
                <div className="flex-1 space-y-4">
                  <div className="flex items-center gap-3 flex-wrap">
                    <StatusBadge
                      ...
                      size="sm"
                    />
                    <span className="font-bold tracking-wide text-sm text-white">{alert.hive}</span>
                    <span className="text-white/20">·</span>
                    <span className="text-xs font-bold tracking-wider uppercase text-white/50">{alert.time}</span>
                  </div>
                  ...
                  <div className="bg-[#a78bfa]/10 border border-[#a78bfa]/20 rounded-2xl p-4 shadow-inner relative overflow-hidden">
                    ...
                    <p className="text-sm font-medium text-white/80 leading-snug relative z-10">
                      {alert.aiReasoning}
                    </p>
                  </div>

                  {/* Recommended Action */}
                  <div className="bg-black/40 border border-white/10 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3 shadow-inner">
                ...
                <div className="flex lg:flex-col items-center justify-end gap-3 flex-shrink-0 pt-4 lg:pt-0 border-t border-white/10 lg:border-t-0 w-full lg:w-auto">
                  <button
                  ...
                  <button
                    ...
                    className="w-full lg:w-48 px-4 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-inner"
                  >
        ...
        {filtered.length === 0 && (
          <div className="glass-panel-elevated rounded-3xl border border-white/10 p-12 text-center flex flex-col items-center justify-center">
